#!/usr/bin/env python3
# migration_script_2ba.py
#
# This script creates the ConfigContext for the ConfigSelector microfrontend:
# 1. Creates ConfigContext for state management
...
def create_config_context():
    ...
    # Create ConfigContext.tsx
    config_context = """// File: packages/config-selector/src/contexts/ConfigContext.tsx
...
"""
    ...
    write_file(config_selector_dir / "src" / "contexts" / "ConfigContext.tsx", config_context)
    
    print("ConfigContext created successfully!")

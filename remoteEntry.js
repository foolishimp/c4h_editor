const currentImports = {};
      ...
      let moduleMap = {
"./JobManager":()=>{
      dynamicLoadingCss([], false, './JobManager');
      return __federation_import('./assets/__federation_expose_JobManager.Dybd84dx.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__jobManagement__' + exposeItemName;
